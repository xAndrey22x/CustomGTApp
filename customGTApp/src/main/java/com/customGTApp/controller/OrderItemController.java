...
/**
 * /addOrderProduct/{productId}/{orderId} - add a product to an order, the order item will be received as a request body
 * /addOrderService/{serviceId}/{orderId} - add a service to an order, the order item will be received as a request body
 */
@RestController
